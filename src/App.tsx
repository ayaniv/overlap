...
function App() {
  ...
  const handleQuickSchedule = useCallback(async () => {
    ...
    try {
      ...
      posthog?.capture('meeting_scheduled', { duration_minutes: DEFAULT_MEETING_DURATION_MINUTES });
  ...
  }, [isQuickScheduling, scrubOffsetMs, previewInstant, config.home, config.rings, config.meetings, addMeeting, showToast, resetScrub, posthog]);
  ...
  }, [matchedMeeting, isRemovingMeeting, scrubOffsetMs, removeMeeting, showToast, resetScrub, posthog]);
