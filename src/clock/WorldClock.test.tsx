...
describe('WorldClock Find Time integration', () => {
  it('renders the Find Time button when onFindTime is provided and there is at least one ring', () => {
  ...
  it('hides the Find Time button when onFindTime is not provided', () => {
    renderClock('view', [SF], []);
